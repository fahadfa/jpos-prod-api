...
var AppReport_1 = require("./AppReport");
...
var AppController = /** @class */ (function () {
    ...
    AppController.prototype.getRouter = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, route, _i, _o, path, action, ns;
            return __generator(this, function (_p) {
                switch (_p.label) {
                    ...
                    case 1:
                        ...
                        _f = ["/report"];
                        return [4 /*yield*/, new AppReport_1.AppReport().getRouter()];
                    case 2:
                    ...
                    case 4:
                        ...
                        _p.label = 5;
                    case 5:
                        if (!(_i < _o.length)) return [3 /*break*/, 8];
                        route = _o[_i];
                    ...
                    case 7:
                        _i++;
                        return [3 /*break*/, 5];
                    case 8: return [2 /*return*/, this.router];
                }
            });
        });
    };
