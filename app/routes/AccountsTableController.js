...
var AccountsTableService_1 = require("../services/AccountsTableService");
var AccountsTableController = /** @class */ (function () {
    function AccountsTableController() {
        this.componentName = "AccountsTable";
        this.router = express_1.Router();
        this.service = new AccountsTableService_1.AccountsTableService();
    }
    AccountsTableController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    AccountsTableController.prototype.getRouter = function () {
        var _this = this;
    ...
    return AccountsTableController;
}());
exports.AccountsTableController = AccountsTableController;
