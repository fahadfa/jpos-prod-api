...
var AgentPurchaseOrderController = /** @class */ (function () {
    function AgentPurchaseOrderController() {
        this.componentName = "SalesLine";
        this.router = express_1.Router();
        this.service = new PurchaseOrderFromAxaptaService_1.PurchaseOrderFromAxaptaService();
    }
    AgentPurchaseOrderController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    AgentPurchaseOrderController.prototype.getRouter = function () {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.service.getAgentOrder(reqData)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
        ...
        this.router.put("/", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (!_a.sent()) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.service.saveAgentOrder(reqData)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
                    case 3: throw this.service.sessionInfo ? this.service.sessionInfo : { message: Props_1.Props.TOKEN_MESSAGE };
    ...
    return AgentPurchaseOrderController;
}());
exports.AgentPurchaseOrderController = AgentPurchaseOrderController;
