...
var AppLangService_1 = require("../services/AppLangService");
var AppLangController = /** @class */ (function () {
    function AppLangController() {
        this.router = express_1.Router();
        this.service = new AppLangService_1.AppLangService();
    }
    AppLangController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    AppLangController.prototype.getRouter = function () {
        var _this = this;
    ...
    return AppLangController;
}());
exports.AppLangController = AppLangController;
