...
var BaseSizesService_1 = require("../services/BaseSizesService");
var BaseSizesController = /** @class */ (function () {
    function BaseSizesController() {
        this.router = express_1.Router();
        this.service = new BaseSizesService_1.BaseSizesService();
    }
    BaseSizesController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    BaseSizesController.prototype.getRouter = function () {
        var _this = this;
        ...
        this.router.post("/", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (!_a.sent()) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.service.getbaseSizes(reqData)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
                    case 3: throw this.service.sessionInfo ? this.service.sessionInfo : { message: Props_1.Props.TOKEN_MESSAGE };
    ...
    return BaseSizesController;
}());
exports.BaseSizesController = BaseSizesController;
