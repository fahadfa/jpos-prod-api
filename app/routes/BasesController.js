...
var BasesService_1 = require("../services/BasesService");
var BasesController = /** @class */ (function () {
    function BasesController() {
        this.router = express_1.Router();
        this.service = new BasesService_1.BasesService();
    }
    BasesController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    BasesController.prototype.getRouter = function () {
        var _this = this;
        ...
        this.router.get("/salesorderpageproducts", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.router.get("/:id", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            var reqData, result, params, id, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
