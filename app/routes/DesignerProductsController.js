...
var DesignerProductsService_1 = require("../services/DesignerProductsService");
var DesignerProductsController = /** @class */ (function () {
    function DesignerProductsController() {
        this.router = express_1.Router();
        this.service = new DesignerProductsService_1.DesignerProductsService();
    }
    DesignerProductsController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    DesignerProductsController.prototype.getRouter = function () {
        var _this = this;
    ...
    return DesignerProductsController;
}());
exports.DesignerProductsController = DesignerProductsController;
