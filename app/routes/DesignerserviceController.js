...
var DesignerserviceService_1 = require("../services/DesignerserviceService");
var DesignerserviceController = /** @class */ (function () {
    function DesignerserviceController() {
        this.router = express_1.Router();
        this.service = new DesignerserviceService_1.DesignerserviceService();
    }
    DesignerserviceController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    DesignerserviceController.prototype.getRouter = function () {
        var _this = this;
        ...
        this.router.get("/designerservicelist", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (!_a.sent()) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.service.designerServiceList(reqData)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
                    case 3: throw this.service.sessionInfo ? this.service.sessionInfo : { message: Props_1.Props.TOKEN_MESSAGE };
    ...
    return DesignerserviceController;
}());
exports.DesignerserviceController = DesignerserviceController;
