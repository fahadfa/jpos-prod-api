...
var EcommerceController = /** @class */ (function () {
    function EcommerceController() {
        this.componentName = "SalesLine";
        this.router = express_1.Router();
        this.service = new SalesTableService_1.SalesTableService();
    }
    EcommerceController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    EcommerceController.prototype.getRouter = function () {
        var _this = this;
        this.router.get("/orderdetails/:id", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.service.ecommerceEntity(reqData)];
                    case 1:
        ...
        this.router.post("/orderdetails/:id", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
        ...
        //     }
        // });
        this.router.post("/updatepaymentstatus/", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.service.onlineInvoicePaymentService(reqData)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
