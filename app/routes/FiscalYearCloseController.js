...
var FiscalYearCloseService_1 = require("../services/FiscalYearCloseService");
var FiscalYearCloseController = /** @class */ (function () {
    function FiscalYearCloseController() {
        this.router = express_1.Router();
        this.service = new FiscalYearCloseService_1.FiscalYearCloseService();
    }
    FiscalYearCloseController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    FiscalYearCloseController.prototype.getRouter = function () {
        var _this = this;
    ...
    return FiscalYearCloseController;
}());
exports.FiscalYearCloseController = FiscalYearCloseController;
