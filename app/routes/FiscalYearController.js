...
var FiscalYearService_1 = require("../services/FiscalYearService");
var FiscalYearController = /** @class */ (function () {
    function FiscalYearController() {
        this.router = express_1.Router();
        this.service = new FiscalYearService_1.FiscalYearService();
    }
    FiscalYearController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    FiscalYearController.prototype.getRouter = function () {
        var _this = this;
