...
var FixedAssetGroupService_1 = require("../services/FixedAssetGroupService");
var FixedAssetGroupController = /** @class */ (function () {
    function FixedAssetGroupController() {
        this.router = express_1.Router();
        this.service = new FixedAssetGroupService_1.FixedAssetGroupService();
    }
    FixedAssetGroupController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    FixedAssetGroupController.prototype.getRouter = function () {
        var _this = this;
        ...
        this.router.get("/:id", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            var reqData, result, params, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
    ...
    return FixedAssetGroupController;
}());
exports.FixedAssetGroupController = FixedAssetGroupController;
