...
var FixedAssetTableService_1 = require("../services/FixedAssetTableService");
var FixedAssetTableController = /** @class */ (function () {
    function FixedAssetTableController() {
        this.router = express_1.Router();
        this.service = new FixedAssetTableService_1.FixedAssetTableService();
    }
    FixedAssetTableController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    FixedAssetTableController.prototype.getRouter = function () {
        var _this = this;
    ...
    return FixedAssetTableController;
}());
exports.FixedAssetTableController = FixedAssetTableController;
