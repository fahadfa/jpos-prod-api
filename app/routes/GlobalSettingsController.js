...
var GlobalSettingsController = /** @class */ (function () {
    function GlobalSettingsController() {
        this.router = express_1.Router();
        this.service = new UsergroupConfigService_1.UsergroupConfigService();
        this.rawQuery = new RawQuery_1.RawQuery();
    }
    GlobalSettingsController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    GlobalSettingsController.prototype.getRouter = function () {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.service.findOne()];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
        ...
        this.router.put("/", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (!_a.sent()) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.service.saveAll(reqData)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
                    case 3: throw this.service.sessionInfo ? this.service.sessionInfo : { message: Props_1.Props.TOKEN_MESSAGE };
