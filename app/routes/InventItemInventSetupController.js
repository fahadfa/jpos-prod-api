...
var InventItemInventSetupService_1 = require("../services/InventItemInventSetupService");
var InventItemInventSetupController = /** @class */ (function () {
    function InventItemInventSetupController() {
        this.router = express_1.Router();
        this.service = new InventItemInventSetupService_1.InventItemInventSetupService();
    }
    InventItemInventSetupController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    InventItemInventSetupController.prototype.getRouter = function () {
        var _this = this;
    ...
    return InventItemInventSetupController;
}());
exports.InventItemInventSetupController = InventItemInventSetupController;
