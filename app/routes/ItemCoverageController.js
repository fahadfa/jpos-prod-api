...
var ItemCoverageService_1 = require("../services/ItemCoverageService");
var ItemCoverageController = /** @class */ (function () {
    function ItemCoverageController() {
        this.componentName = "ItemCoverage";
        this.router = express_1.Router();
        this.service = new ItemCoverageService_1.ItemCoverageService();
    }
    ItemCoverageController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    ItemCoverageController.prototype.getRouter = function () {
        var _this = this;
    ...
    return ItemCoverageController;
}());
exports.ItemCoverageController = ItemCoverageController;
