...
var KeyController = /** @class */ (function () {
    function KeyController() {
        this.router = express_1.Router();
        this.keyService = new KeyService_1.KeyService();
    }
    KeyController.prototype.checkProceed = function (request) { };
    KeyController.prototype.getRouter = function () {
        var _this = this;
        this.router.post("/", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    Log_1.log.info("key Controller ");
                    reqData = request.body ? request.body.data : {};
                    sessionInfo = {};
                    result = null;
                    if (reqData) {
                        result = this.keyService.key(reqData);
                    }
                    else {
