...
var OverDueController = /** @class */ (function () {
    function OverDueController() {
        this.componentName = "OverDue";
        this.router = express_1.Router();
        this.service = new OverDueService_1.OverDueService();
    }
    OverDueController.prototype.getRouter = function () {
        var _this = this;
        ...
        this.router.get("/creditused/:id", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (!_a.sent()) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.service.getCreditUsed(id)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
                    case 3: throw this.service.sessionInfo ? this.service.sessionInfo : { message: Props_1.Props.TOKEN_MESSAGE };
