...
var SalesLineService_1 = require("../services/SalesLineService");
var SalesLineController = /** @class */ (function () {
    function SalesLineController() {
        this.componentName = "SalesLine";
        this.router = express_1.Router();
        this.service = new SalesLineService_1.SalesLineService();
    }
    SalesLineController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    SalesLineController.prototype.getRouter = function () {
        var _this = this;
...
exports.SalesLineController = SalesLineController;
