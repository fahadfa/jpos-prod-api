...
var SyncSourceController = /** @class */ (function () {
    function SyncSourceController() {
        this.componentName = "SyncSource";
        this.router = express_1.Router();
        this.service = new SyncSourceService_1.SyncSourceService();
    }
    SyncSourceController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    SyncSourceController.prototype.getRouter = function () {
        var _this = this;
    ...
    return SyncSourceController;
}());
exports.SyncSourceController = SyncSourceController;
