...
var UsesrInfoService_1 = require("../services/UsesrInfoService");
var RawQuery_1 = require("../common/RawQuery");
var UserInfoController = /** @class */ (function () {
    function UserInfoController() {
        this.router = express_1.Router();
        this.service = new UsesrInfoService_1.UsesrInfoService();
        this.rawQuery = new RawQuery_1.RawQuery();
    }
    UserInfoController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    UserInfoController.prototype.getRouter = function () {
        var _this = this;
        ...
        this.router.post("/changepassword", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (!_a.sent()) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.service.changePassword(reqData)];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
                    case 3: throw this.service.sessionInfo ? this.service.sessionInfo : { message: Props_1.Props.TOKEN_MESSAGE };
        ...
        this.router.delete("/:id", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            var reqData, result, params, id, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
