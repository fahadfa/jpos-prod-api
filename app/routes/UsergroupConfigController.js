...
var UsergroupConfigService_1 = require("../services/UsergroupConfigService");
var RawQuery_1 = require("../common/RawQuery");
var UsergroupConfigController = /** @class */ (function () {
    function UsergroupConfigController() {
        this.router = express_1.Router();
        this.service = new UsergroupConfigService_1.UsergroupConfigService();
        this.rawQuery = new RawQuery_1.RawQuery();
    }
    UsergroupConfigController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    UsergroupConfigController.prototype.getRouter = function () {
        var _this = this;
        ...
        this.router.delete("/:id", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            var reqData, result, params, id, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
    ...
    return UsergroupConfigController;
}());
exports.UsergroupConfigController = UsergroupConfigController;
