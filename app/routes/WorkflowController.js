...
var WorkflowController = /** @class */ (function () {
    function WorkflowController() {
        ...
        this.service = new WorkflowService_1.WorkflowService();
    }
    WorkflowController.prototype.moduleName = function () {
        return this.constructor.name;
    };
    WorkflowController.prototype.getRouter = function () {
        var _this = this;
        ...
        this.router.put("/sendforapproval", function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (!_a.sent()) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.service.save(reqData, "sendforapproval")];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 4];
                    case 3: throw this.service.sessionInfo ? this.service.sessionInfo : { message: Props_1.Props.TOKEN_MESSAGE };
